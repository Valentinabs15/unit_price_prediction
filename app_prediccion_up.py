...
.hero :not(input):not(textarea):not(select) { 
  color: #fff !important;
  text-shadow: 0 1px 2px rgba(0,0,0,.8);
}
.hero h1 { font-size: 44px; line-height: 1.1; margin: 4px 0 10px 0; }
.hero input, .hero textarea { color: #111 !important; background: #fff !important; }
.hero [data-baseweb="select"] * { color: #111 !important; }
.hero .stNumberInput input { color: #111 !important; }
.hero .stTextInput input { color: #111 !important; }
.hero .stSelectbox > div > div { color: #111 !important; }
.hero .stButton>button { width: 100%; font-weight: 600; box-shadow: 0 6px 16px rgba(0,0,0,.25); }
